...
<br>
Our study took place at ten different sites throughout the Mexican Caribbean (See Figure 1). We caught 109 lionfish using handheld nets and numbered containers, with no regard to age, size, depth, gender, or other factors. The depth (nearest 0.1 m) and exact location (latitude and longitude) at which they were found were immediately recorded upon capture, and their total length (to the nearest 1 mm) and total weight (nearest 0.01 g) were measured upon reaching the surface.
<br>
